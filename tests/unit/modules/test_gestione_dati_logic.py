...
class TestGestioneDatiLogic(unittest.TestCase):
    ...
    def test_render_gestione_dati_save(self, mock_save, mock_names, mock_data, mock_succ, mock_btn, mock_sel, mock_edit):
    ...
    def test_render_esclusioni_flow(self, mock_val, mock_all, mock_get_users, mock_add, mock_btn, mock_sel, mock_edit, mock_rerun):
        # Setup users
        ...
        mock_all.return_value = [{"pdl": "101", "attivita": "Test", "team": [{"nome": "T1"}], "Data Assegnamento": "2023-01-01"}]
