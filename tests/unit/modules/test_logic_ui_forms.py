...
def test_debriefing_form_validation(mocker):
    ...
    mock_save = mocker.patch("src.components.forms.debriefing_form.scrivi_o_aggiorna_risposta")
...
def test_debriefing_form_success(mocker):
    ...
    mocker.patch("src.components.forms.debriefing_form.scrivi_o_aggiorna_risposta", return_value=True)
...
def test_relazione_submission_validation(mocker):
    ...
    mock_db = mocker.patch("src.components.forms.relazione_oncall_form.salva_relazione")
...
def test_relazione_submission_full_flow(mocker):
    ...
    mock_db = mocker.patch("src.components.forms.relazione_oncall_form.salva_relazione", return_value=True)
    mock_email = mocker.patch("src.components.forms.relazione_oncall_form.invia_email_con_outlook_async")
