...
class TestOncallCalendarLogic(unittest.TestCase):
    ...
    def test_render_reperibilita_tab_base(
        self, mock_grid, mock_nav, mock_exp, mock_filt, mock_div, mock_tabs, mock_sub
    ):
    ...
    def test_render_day_cell_admin_edit(self):
        ...
        with (
            ...
            calendar._render_day_cell(day, today, shifts, df_p, m_to_n, "ADM01", "Amministratore")
    ...
    def test_render_calendar_grid_calls_day_cell(self):
        ...
        with (
            ...
            calendar._render_oncall_calendar_grid(
                pd.DataFrame(),
                pd.DataFrame(columns=["Matricola", "Nome Cognome"]),
                "ADM01",
                "Amministratore",
            )
