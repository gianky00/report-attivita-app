...
class TestStoricoLogic(unittest.TestCase):
    ...
    def test_render_storico_complete(self, mock_ass, mock_mat, mock_rel, mock_int, mock_area, mock_md, mock_exp, mock_input, mock_sub, mock_tabs):
        # Mock tabs
        ...
        mock_int.return_value = pd.DataFrame([
            {
                "id_report": 1, "pdl": "P101", "descrizione_attivita": "DESC1", 
                "nome_tecnico": "T1", "stato_attivita": "Validato",
                "data_riferimento_attivita": "2023-01-01", "data_compilazione": "2023-01-02",
                "testo_report": "TEST1"
            },
            {
                "id_report": 2, "pdl": "P101", "descrizione_attivita": "DESC1_ALT", 
                "nome_tecnico": "T2", "stato_attivita": "Validato",
                "data_riferimento_attivita": "2023-01-05", "data_compilazione": "2023-01-06",
                "testo_report": "TEST2"
            }
        ])
        ...
        mock_rel.return_value = pd.DataFrame([
            {
                "id_relazione": "R1", "data_intervento": "2023-02-01", 
                "tecnico_compilatore": "T1", "partner": "T2",
                "ora_inizio": "08:00", "ora_fine": "12:00", "corpo_relazione": "TEXT1"
            }
        ])
        ...
        mock_mat.return_value = pd.DataFrame([
            {
                "id_storico": "M1", "timestamp_richiesta": "2023-03-01 10:00", 
                "nome_richiedente": "T1", "dettagli_richiesta": "MAT1"
            }
        ])
        ...
        mock_ass.return_value = pd.DataFrame([
            {
                "id_storico": "A1", "data_inizio": "2023-04-01", "data_fine": "2023-04-05",
                "tipo_assenza": "Ferie", "nome_richiedente": "T1", "note": "NOTE1"
            }
        ])
    ...
    @patch('pages.storico.get_storico_richieste_materiali')
    @patch('pages.storico.get_storico_richieste_assenze')
    def test_render_storico_empty(self, mock_ass, mock_mat, mock_rel, mock_int, mock_succ, mock_tabs):
