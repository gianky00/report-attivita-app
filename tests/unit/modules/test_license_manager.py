...
def test_check_pyarmor_license_missing(mocker):
    ...
    mocker.patch("src.modules.license_manager.Path.exists", return_value=False)
    mock_logger = mocker.patch("src.modules.license_manager.logging")
...
def test_check_pyarmor_license_found(mocker):
    ...
    mocker.patch("src.modules.license_manager.Path.exists", return_value=True)
    mocker.patch(
        "src.modules.license_manager.Path.read_text",
