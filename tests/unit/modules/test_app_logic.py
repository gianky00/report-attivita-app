...
class TestAppLogic(unittest.TestCase):
    def setUp(self):
        ...
        # Module patches (patch where used in app.py)
        for name in [
    ...
    def test_verify_2fa_success(self):
        ...
        self.mocks['get_user_by_matricola'].return_value = {"Matricola": "M123", "Nome Cognome": "Mario Rossi", "Ruolo": "admin", "2FA_Secret": "SECRET"}
